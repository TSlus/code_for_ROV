...
{
	math::Ray3f p; p.o = v1->position; p.d = v2->position;

	return math::intersectionRayPlane( p, normal, distance, intersectionPoint );
}
...
{
	math::Ray3f p; p.o = v1->position; p.d = v2->position;
	math::Ray3f q; q.o = p1; q.d = p2;
	return math::intersectionRayRay( p, q, intersectionPoint );	
}
...
bool MeshEx::Edge::intersectsLine( const math::Vec3f &p1, const math::Vec3f &p2 )
{
	...
	return math::intersectionRayRay(p, q, intersection);
}
